...
import { Target, Eye, Heart, Globe2, Factory, TrendingDown } from "lucide-react";
  ...
  head: () => ({
    meta: [
      { title: "About BABA | Buy Africa Build Africa" },
      {
        name: "description",
        content:
          "Why BABA exists: ending raw-material dependency and building Africa's industrial future through skills, local value addition and partnership.",
      },
    ],
