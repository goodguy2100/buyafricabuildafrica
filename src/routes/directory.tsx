...
const profiles: Profile[] = [
  {
    ...
    years: 12,
    experience: "Expert",
    tags: ["Ceramic Tiling", "Geometric Layouts", "Mosaic Work"],
    phone: "+254 746216258",
    email: "john.mwangi@buyafricabuildafrica.org",
  },
  {
    id: 2,
    name: "Sarah Ochieng",
    ...
    email: "sarah.ochieng@buyafricabuildafrica.org",
  },
  {
    id: 3,
    name: "Moussa Diop",
    ...
    years: 10,
    experience: "Expert",
    tags: ["Masonry", "Concrete Finishing", "Structural Works"],
    phone: "+250 788 450 990",
    email: "moussa.diop@buyafricabuildafrica.org",
  },
  {
    id: 4,
    name: "Amina Bello",
    ...
    email: "amina.bello@buyafricabuildafrica.org",
  },
  {
    id: 5,
    name: "Kenji Kamau",
    ...
    email: "kenji.kamau@buyafricabuildafrica.org",
  },
  {
    id: 6,
    name: "David Osei",
    ...
    years: 9,
    experience: "Intermediate",
    tags: ["Industrial Plumbing", "Maintenance", "Pipe Fitting"],
    phone: "+233 244 660 330",
    email: "david.osei@buyafricabuildafrica.org",
  },
  {
    id: 7,
    name: "Peter Njoroge",
    ...
    years: 14,
    experience: "Expert",
    tags: ["Stone Masonry", "Brickwork", "Plastering"],
    phone: "+254 746216258",
    email: "peter.njoroge@buyafricabuildafrica.org",
  },
  {
    id: 8,
    name: "Grace Achieng",
    initials: "GA",
    role: "Artisans · Electrician",
    category: "Artisans",
    location: "Kisumu, Kenya",
    years: 7,
    experience: "Intermediate",
    tags: ["Residential Wiring", "Solar Installation", "Electrical Repairs"],
    phone: "+254 722 334 556",
    email: "grace.achieng@buyafricabuildafrica.org",
  },
  {
    id: 9,
    name: "James Mutua",
    initials: "JM",
    role: "Artisans · Carpenter",
    category: "Artisans",
    location: "Mombasa, Kenya",
    years: 11,
    experience: "Expert",
    tags: ["Finish Carpentry", "Furniture", "Roofing"],
    phone: "+254 733 112 233",
    email: "james.mutua@buyafricabuildafrica.org",
  },
  {
    id: 10,
    name: "Hassan Ibrahim",
    initials: "HI",
    role: "Artisans · Welder",
    category: "Artisans",
    location: "Eldoret, Kenya",
    years: 10,
    experience: "Expert",
    tags: ["MIG Welding", "Steel Fabrication", "Gates & Grills"],
    phone: "+254 720 445 678",
    email: "hassan.ibrahim@buyafricabuildafrica.org",
  },
  {
    id: 11,
    name: "Lucy Wanjiku",
    initials: "LW",
    role: "Artisans · Painter",
    category: "Artisans",
    location: "Nairobi, Kenya",
    years: 6,
    experience: "Intermediate",
    tags: ["Interior Painting", "Exterior Finishes", "Texture Coating"],
    phone: "+254 712 998 877",
    email: "lucy.wanjiku@buyafricabuildafrica.org",
  },
  {
    id: 12,
    name: "Samuel Kipchirchir",
    initials: "SK",
    role: "Artisans · Gypsum Specialist",
    category: "Artisans",
    location: "Nakuru, Kenya",
    years: 8,
    experience: "Intermediate",
    tags: ["Gypsum Ceiling", "Drywall Partition", "Decorative Molding"],
    phone: "+254 725 667 889",
    email: "samuel.kipchirchir@buyafricabuildafrica.org",
  },
];
